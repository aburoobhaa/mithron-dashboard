...
# Construct correct path to logo
logo_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "assets", "logo2.png"))
# -------------------------------
# ⚙️ Setup Page
# -------------------------------
...
# 🍗 Theme Switch
# -------------------------------
# Load and encode the uploaded logo
...
with st.sidebar:
    ...
    st.markdown(f"""
        <div style="text-align: center; margin-bottom:8x;">
            <img src="data:image/png;base64,{encoded_logo}" width="165">
        </div>
